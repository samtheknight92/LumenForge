...
function inferEffectType(desc) {
  ...
  if (/^craft:/i.test(text)) return 'craft'
...
const BUFF_EFFECTS = {
  ...
  dirty_trick_buff: {
    ...
    duration: 1,
    potency: 0,
    desc: '+2 accuracy on the ally\'s next attack roll vs the distracted target.',
    stackable: false,
  ...
  volley_call_buff: {
    ...
    duration: 1,
    potency: 0,
    desc: '+1 accuracy on the next attack roll vs the called target.',
    stackable: false,
    statModifiers: { accuracy: 1 },
    manual: false
  },
...
/** Scene weather — environmental modifiers (see Character → Effects weather tracker). */
const WEATHER_EFFECTS = {
  weather_rain: {
    ...
    type: 'weather',
    duration: 0,
    desc: 'Heavy rain makes footing slippery, obscures vision and dampens flames. Water magic becomes easier to control while fire struggles to stay lit. The charged atmosphere makes lightning magic easier to land.',
    elementAccuracyModifiers: { lightning: 2, water: 2, fire: -2 },
    stackable: false,
    manual: false
  },
  weather_heatwave: {
    ...
    type: 'weather',
    duration: 0,
    desc: 'Oppressive heat drains stamina and makes concentration difficult. Water evaporates quickly while ice melts before reaching its target.',
    elementAccuracyModifiers: { ice: -2, water: -2 },
    processTurnStaminaDrain: 1,
    stackable: false,
    manual: false
  },
  weather_blizzard: {
    ...
    type: 'weather',
    duration: 0,
    desc: 'Freezing winds and heavy snowfall reduce visibility while making movement slow and exhausting.',
  ...
  weather_fog: {
    ...
    type: 'weather',
    duration: 0,
    desc: 'A thick blanket of fog obscures the battlefield, making it difficult to accurately judge distance and identify targets.',
  ...
  weather_sandstorm: {
    ...
    type: 'weather',
    duration: 0,
    desc: 'Blowing sand stings the eyes, clogs armour and makes it difficult to keep your footing.',
    statModifiers: { accuracy: -2, physicalDefence: -1 },
    stackable: false,
    manual: false
  },
  weather_thunderstorm: {
    ...
    type: 'weather',
    duration: 0,
    desc: 'Torrential rain and crashing thunder make ranged attacks difficult, but lightning magic becomes incredibly dangerous.',
    statModifiers: { accuracy: -1 },
    elementAccuracyModifiers: { lightning: 2 },
    stackable: false,
    manual: false
  },
  weather_ashfall: {
    ...
    type: 'weather',
    duration: 0,
    desc: 'Volcanic ash blankets the landscape, reducing visibility while feeding nearby flames.',
    statModifiers: { speed: -1 },
    elementAccuracyModifiers: { fire: 2 },
    stackable: false,
    manual: false
  },
  weather_mana_storm: {
    id: 'weather_mana_storm',
    name: 'Mana Storm',
    icon: '🌌',
    type: 'weather',
    duration: 0,
    desc: 'Wild magical energy saturates the area, making spells unpredictable as the flow of mana constantly shifts.',
    manaStorm: true,
    stackable: false,
    manual: false
  }
...
for (const [id, effect] of Object.entries(WEATHER_EFFECTS)) {
  effects[id] = effect
}

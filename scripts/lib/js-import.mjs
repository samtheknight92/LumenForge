...
const BASENAME_PATHS = {
  ...
  'focused-skills.js': 'skills/focused-skills.js',
  ...
  'active-encounter.js': 'gm/active-encounter.js',
  'gm-npc-turn.js': 'gm/gm-npc-turn.js',
  'guided-create.js': 'ui/guided-create.js',
  'actions.js': 'ui/actions.js',
  'stat-costs.js': 'character/stat-costs.js',

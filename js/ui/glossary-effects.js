import { effectDurationLabel } from '../effects/effects.js'
...
export const EFFECT_ALIASES = {
  ...
  fear_immunity: ['immune to fear', 'fear immune', 'brave heart'],
  charm_immunity: ['immune to charm', 'charm immune'],
  fire_immunity: ['immune to fire', 'fire immune'],
  fire_resistance: ['fire resist', 'resist fire'],
  ice_resistance: ['ice resist', 'resist ice'],
  spell_warded: ['warded', 'spell warding'],

...
import { buildMaxStatGlossaryEntries } from '../character/max-stat-rewards.js'
...
export const GLOSSARY_ENTRIES = [
  ...
  },
  {
    ...
    detail: 'Greyed skills are locked. Hover or read the card — it lists required skills, minimum Skill Level, or incompatible skills you already have. GM Mode ignores prerequisites for testing builds.'
  },
  {
    id: 'harmony',
    term: 'Harmony',

...
export const HOMEBREW_ITEM_TYPES = ['weapon', 'armor', 'accessory', 'offhand', 'consumable', 'material']
export const HOMEBREW_OFFHAND_TYPES = ['shield', 'tome', 'focus', 'instrument', 'weapon']
export const HOMEBREW_WEAPON_HANDS = [
  { id: 'one', label: 'One-handed' },
  { id: 'two', label: 'Two-handed' }
]
export const HOMEBREW_BALANCE_TAGS = [
  'damage', 'defence', 'healing', 'control', 'mobility', 'actionEconomy', 'status', 'summon', 'highRisk', 'bossTool'
]
export const HOMEBREW_APPROVAL_STATUSES = [
  { id: 'draft', label: 'Draft' },
  { id: 'approved', label: 'Approved' },
  { id: 'hidden', label: 'Hidden' }
]
export const HOMEBREW_SKILL_APPLY_TO = [
  { id: 'self', label: 'Self' },
  { id: 'oneAlly', label: 'One ally' },
  { id: 'oneEnemy', label: 'One enemy' },
  { id: 'allAllies', label: 'All allies' },
  { id: 'allEnemies', label: 'All enemies' },
  { id: 'area', label: 'Area' }
]
export const HOMEBREW_SKILL_EFFECT_KINDS = [
  'damage', 'healing', 'barrier', 'buff', 'debuff', 'status', 'movement', 'utility'
]
export const HOMEBREW_SKILL_USE_LIMITS = [
  { id: '', label: 'No limit' },
  { id: 'oncePerCombat', label: 'Once per combat' },
  { id: 'oncePerRest', label: 'Once per rest' }
]

...
import { registerMaxStatRewardEffects } from '../character/max-stat-rewards.js'
import { titleCase } from './utils.js'
import { formatStatModifiers } from '../ui/format.js'
import { itemPlayerSearchText } from '../items/item-presentation.js'
...
function buildItemSearchText(item) {
  return itemPlayerSearchText(item)
}

...
/** Tier 5 skill = exactly 1 level; tier N contributes N ÷ 5. Shared by Skill Level and Combat Power. */
export function tierLevelValue(tier) {
  return Number(tier || 1) / 5
}

/** HP & Stamina upgrades count as tier 1; all other stats as tier 2. Shared by Combat Power. */
...
/**
 * @deprecated Old combined Level (skills + raw stat purchases) — superseded by
 * Skill Level (skill-level.js) + Combat Power (combat-power.js). Kept only as a
 * legacy helper for any code that hasn't migrated yet; do not use in new UI.
 */
...
/** @deprecated see characterLevelInfo */

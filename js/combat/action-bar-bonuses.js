import { cache, getRace, getSkill } from '../core/cache.js'
import { characterWieldsWeaponKind } from '../items/equipment.js'
import { titleCase } from '../core/utils.js'
import { displayCategory } from '../skills/skills.js'
...
export { ANY_WEAPON_KIND } from '../core/constants.js'
...
export function getActionBarSkillBonuses(character, skill) {
  ...
  for (const bonus of weatherAccuracyBonuses(character, skill)) {
    if (!bonus.value || !benefitStats.has(bonus.stat)) continue
    pushBonus(bonuses, seen, bonus)
  }

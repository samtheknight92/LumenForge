  ...
  bar.innerHTML = `
    <div class="action-bar-dock">
      <div class="action-bar-inner">
        ...
        ${pinned.length ? `
        <div class="action-bar-skills-wrap pinned-skills">
          <div class="action-bar-skills-label">📌 Pinned</div>
          <div class="action-bar-skills" role="toolbar" aria-label="Pinned skills">
            ${renderActionBarSkillSlots(pinned, character)}
          </div>
        </div>` : ''}

    ...
    const RACES_DATA = {
        ...
        dwarf: {
            ...
            passiveTraits: [
                ...
                "Dwarven Resilience: +2 Physical Defence, +1 HP. Immune to poison status effects",
        ...
        halfling: {
            ...
            passiveTraits: [
                ...
                "Small & Nimble: +2 Speed, +1 Accuracy. Can move through larger creature spaces",
        ...
        orc: {
            ...
            passiveTraits: [
                ...
                "Powerful Build: +2 Strength, +1 HP. +1 damage with melee weapons, +2 carrying capacity"
            ],
            statModifiers: {
                strength: 2,
                hp: 1
        ...
        human: {
            ...
            passiveTraits: [
                "Versatile Learning: +1 HP, +1 Stamina, +1 Accuracy. Gain one free Tier 1 weapon skill upon character creation",
        ...
        dragonborn: {
            ...
            passiveTraits: [
                ...
                "Scaled Hide: +1 Physical Defence, +1 Magical Defence, +1 Strength. Resistance to chosen element damage",
        ...
        tiefling: {
            ...
            passiveTraits: [
                ...
                "Fiendish Cunning: +1 Magic Power, +1 Magical Defence, +1 Stamina. Bonus to social manipulation at the table"
            ],
            statModifiers: {
                magicPower: 1,
                magicalDefence: 1,
        ...
        drow: {
            ...
            passiveTraits: [
                "Superior Darkvision: +1 Speed, +1 Magic Power, +1 Magical Defence. Perfect vision in complete darkness (extended range)",
        ...
        gnoll: {
            ...
            passiveTraits: [
                ...
                "Savage Instincts: +1 Strength, +1 Speed, +1 HP. +1 damage against enemies below 50% HP"
            ],
            statModifiers: {
                strength: 1,
                speed: 1,

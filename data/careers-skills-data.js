...
const CAREERS_SKILLS_DATA = {
    ...
    "ranger": [
        ...
        },
        {
            ...
            "cost": 40,
            "staminaCost": 0,
            "desc": "Action: Marked quarry — call out one target; one ally gains +1 accuracy on their next attack roll vs it. Once per combat. + Harmony Reaction: same target (each Ranger adds +1 accuracy to marked allies' next attack roll vs that target and marks one more ally).",
            "icon": "📣",
            "prerequisites": {
                "type": "AND",
                "skills": [
    ...
    "thief": [
        ...
        },
        {
            ...
            "cost": 20,
            "staminaCost": 0,
            "desc": "Action: Distraction setup — distract a foe; one ally gains +2 accuracy on their next attack roll vs that target. + Harmony Reaction: same foe (each additional Thief adds +1 accuracy to that attack roll).",
            "icon": "🎭",
            "prerequisites": {
                "type": "AND",
                "skills": [

...
const ITEMS_DATA = {
    ...
    "cursed_equipment": {
        "bow_of_instant_death": {
            "id": "bow_of_instant_death",
            "name": "Bow of Instant Death",
            "type": "weapon",
            "weaponKind": "ranged",
            "hands": "two",
            "damage": "2d8",
            "statModifiers": { "speed": 3, "strength": 2, "accuracy": 1 },
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "A magnificent bow that radiates divine energy. +3 Speed, +2 Strength, +1 Accuracy. Damage: 2d8. Track Glowing Orbs on the sheet (0–20).",
            "icon": "🏹",
            "price": { "gold": 15 },
            "rarity": "legendary",
            "tags": ["cursed", "bow"],
            "isCursed": true,
            "curseStyle": "trigger",
            "hiddenGMDescription": "Each glowing orb is a trapped Ethereal Horror. The bow whispers encouragement when the wielder draws it.",
            "hiddenGMAbility": "When orbs reach 20, the next shot automatically summons an Ethereal Horror at the target — no roll. Removing the curse requires a table story beat, not a button.",
            "hiddenGMNotes": "Reference implementation: tempting power, hidden consequence, manual tracker, story reveal. Do not auto-increment orbs.",
            "counterLabel": "Glowing Orbs",
            "counterDefault": 0,
            "counterMax": 20,
            "blockRemoveWithCounter": true,
            "counterEquippedOnly": true
        },
        "blade_of_hungry_shadows": {
            "id": "blade_of_hungry_shadows",
            "name": "Blade of Hungry Shadows",
            "type": "weapon",
            "weaponKind": "sword",
            "damage": "1d10",
            ...
            "specialEffects": [],
            "enchantmentSlots": 1,
            "desc": "A sleek dark sword that drinks the light around it. +5 Strength. Damage: 1d10. 1 enchantment slot.",
            "icon": "🗡️",
            "price": { "gold": 12 },
            "rarity": "epic",
            "tags": ["cursed", "sword"],
        ...
        "staff_of_borrowed_light": {
            "id": "staff_of_borrowed_light",
            "name": "Staff of Borrowed Light",
            "type": "weapon",
            "weaponKind": "staff",
            "damage": "1d8",
            "statModifiers": { "magicPower": 5 },
            "specialEffects": [],
            "enchantmentSlots": 1,
            "desc": "A pale staff that glows softly in dim places. +5 Magic Power. Damage: 1d8. 1 enchantment slot.",
            "icon": "🪄",
            "price": { "gold": 9 },
            "rarity": "rare",
            "tags": ["cursed", "staff"],
            "isCursed": true,
            "curseStyle": "narrative",
            "hiddenGMDescription": "The light is stolen from a bound spirit inside the crystal head.",
            "hiddenGMAbility": "In total darkness the staff sheds bright light — but allies within 10 ft feel uneasy (−1 to social checks while lit, GM call). The spirit sometimes whispers through the glow.",
            "hiddenGMNotes": "Obvious combat upside; social unease is the trade-off. Good starter curse."
        },
        "ring_of_false_comfort": {
            "id": "ring_of_false_comfort",
            "name": "Ring of False Comfort",
            "type": "accessory",
            "statModifiers": { "stamina": 4 },
            "specialEffects": [],
            "desc": "A gold ring set with a milky stone. +4 Stamina while worn.",
            "icon": "💍",
            "price": { "gold": 7 },
            "rarity": "rare",
            "tags": ["cursed", "ring"],
            "isCursed": true,
            "curseStyle": "combat",
            "hiddenGMDescription": "The stone is a frozen tear from a sorrow spirit.",
            "hiddenGMAbility": "When the wearer drops below half Stamina, they must pass a simple Will check or become Distracted for 1 turn (GM sets DC by scene).",
            "hiddenGMNotes": "Players love the +4 Stamina until the first crisis."
        },
        "cursed_buckler": {
            "id": "cursed_buckler",
            "name": "Cursed Buckler",
            "type": "offhand",
            "offhandType": "shield",
            "statModifiers": { "physicalDefence": 5 },
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "A small black shield embossed with a grinning face. +5 Physical Defence. Off-hand only.",
            "icon": "🛡️",
            "price": { "gold": 6 },
            "rarity": "uncommon",
            "tags": ["cursed", "shield"],
            "isCursed": true,
            "curseStyle": "trigger",
            "hiddenGMDescription": "The face shifts when nobody is looking directly at it.",
            "hiddenGMAbility": "If the bearer blocks an attack with this shield, the attacker hears faint laughter (flavour). Once per session the shield cracks audibly — no stat loss, but the table knows the curse noticed.",
            "hiddenGMNotes": "Pair with a one-handed weapon. The crack is a story beat, not a stat hit."
        },
        "armour_of_unravelling": {
            "id": "armour_of_unravelling",
            "name": "Armour of Unravelling",
            "type": "armor",
            "statModifiers": { "physicalDefence": 6, "magicalDefence": 4 },
            "specialEffects": [],
            "enchantmentSlots": 1,
            "desc": "Fine mail that seems to knit itself together after every battle. +6 Physical Defence, +4 Magical Defence. 1 enchantment slot.",
            "icon": "🥋",
            "price": { "gold": 14 },
            "rarity": "epic",
            "tags": ["cursed", "armor"],
            "isCursed": true,
            "curseStyle": "trigger",
            "hiddenGMDescription": "Threads of shadow replace broken links overnight.",
            "hiddenGMAbility": "After each long rest, roll 1d6. On a 1, the armour sheds one thread — −1 Physical Defence until repaired (craft or story).",
            "hiddenGMNotes": "Track the penalty on the sheet; repair is a roleplay beat."
        },
        "achilles_dagger": {
            "id": "achilles_dagger",
            "name": "Achilles' Dagger",
            "type": "weapon",
            "weaponKind": "dagger",
            "damage": "1d6",
            "statModifiers": { "strength": 5 },
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "A cruelly sharp dagger that feels unnaturally eager in your hand. +5 Strength. Damage: 1d6.",
            "icon": "🗡️",
            "price": { "gold": 4 },
            "rarity": "common",
            "tags": ["cursed", "dagger"],
            "isCursed": true,
            "curseStyle": "combat",
            "hiddenGMDescription": "The blade drinks from both victim and wielder.",
            "hiddenGMAbility": "Whenever this weapon deals damage, the wielder immediately suffers damage equal to half the damage dealt (rounded down).",
            "hiddenGMNotes": "Common rarity, uncommon power — the self-harm is the reveal."
        },
        "bloodletter_axe": {
            "id": "bloodletter_axe",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "A massive axe that thirsts for violence. +10 Strength. Damage: 2d6. Critical hits restore HP equal to the weapon's damage dice (GM applies).",
            "icon": "🪓",
            "price": { "gold": 16 },
            "rarity": "legendary",
            "tags": ["cursed", "axe"],
            "isCursed": true,
            "curseStyle": "combat",
            "hiddenGMDescription": "The axe is happiest when the ground runs red.",
            "hiddenGMAbility": "If the wielder finishes a combat without drawing blood, they instead lose HP equal to their Strength bonus (minimum 5).",
            "hiddenGMNotes": "Crit-heal is player-facing flavour; the bloodless combat tax is the real curse."
        },
        "dragonheart_armour": {
            "id": "dragonheart_armour",
            "name": "Dragonheart Armour",
            "type": "armor",
            "statModifiers": { "physicalDefence": 12 },
            "specialEffects": ["fire_immunity"],
            "enchantmentSlots": 0,
            "desc": "Scale mail warm as a living furnace. +12 Physical Defence. Immune to Burn.",
            "icon": "🐉",
            "price": { "gold": 20 },
            "rarity": "legendary",
            "tags": ["cursed", "armor"],
            "isCursed": true,
            "curseStyle": "combat",
            "hiddenGMDescription": "Dragonfire still lives in the scales — water quenches dragons.",
            "hiddenGMAbility": "Water attacks against the wearer always Crit.",
            "hiddenGMNotes": "Tempting tank gear. Reveal the water weakness when it matters."
        },
        "helm_of_truth": {
            "id": "helm_of_truth",
            "name": "Helm of Truth",
            "type": "armor",
            "statModifiers": { "magicalDefence": 5 },
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "A gleaming helm that steadies the mind. +5 Magical Defence. Immune to Fear.",
            "icon": "⛑️",
            "price": { "gold": 8 },
            "rarity": "rare",
            "tags": ["cursed", "armor"],
            "isCursed": true,
            "curseStyle": "narrative",
            "hiddenGMDescription": "The helm knows when you lie — and punishes the attempt.",
            "hiddenGMAbility": "The wearer cannot knowingly tell a lie.",
            "hiddenGMNotes": "Roleplay curse. Social scenes become memorable fast."
        },
        "lantern_of_lost_souls": {
            "id": "lantern_of_lost_souls",
            "name": "Lantern of Lost Souls",
            "type": "accessory",
            "statModifiers": {},
            "specialEffects": [],
            "desc": "A ghostly lantern that never needs fuel or trimming. Sheds bright light.",
            "icon": "🏮",
            "price": { "gold": 5 },
            "rarity": "uncommon",
            "tags": ["cursed", "light"],
            "isCursed": true,
            "curseStyle": "narrative",
            "hiddenGMDescription": "The flame is borrowed from wandering dead.",
            "hiddenGMAbility": "Every night the lantern attracts wandering spirits (GM decides friendly, curious, or hostile).",
            "hiddenGMNotes": "No stat downside — story complications only."
        },
        "mirrorblade": {
            "id": "mirrorblade",
            "name": "Mirrorblade",
            ...
            "weaponKind": "sword",
            "damage": "1d8",
            "statModifiers": { "strength": 3, "magicalDefence": 2 },
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "A polished sword that reflects every blow. +3 Strength, +2 Magical Defence. Damage: 1d8. Copies the last skill used against you (GM adjudicates).",
            "icon": "🪞",
            "price": { "gold": 10 },
            "rarity": "epic",
            "tags": ["cursed", "sword"],
            "isCursed": true,
            "curseStyle": "trigger",
            "hiddenGMDescription": "The mirror does not discriminate between gift and wound.",
            "hiddenGMAbility": "When you copy a skill, you also copy every negative status effect attached to that skill.",
            "hiddenGMNotes": "Player-facing copy is a huge upside; the mirrored debuff is the sting."
        },
        "lucky_amulet": {
            "id": "lucky_amulet",
            "name": "Lucky Amulet",
            ...
            "specialEffects": [],
            "desc": "A worn amulet that always tilts fortune your way. +1 Accuracy. One reroll each combat.",
            "icon": "📿",
            "price": { "gold": 6 },
            "rarity": "uncommon",
            "tags": ["cursed", "amulet"],
            "isCursed": true,
            "curseStyle": "trigger",
            "hiddenGMDescription": "Luck borrowed must be repaid.",
            "hiddenGMAbility": "The failed roll is transferred to a random ally later during the session.",
            "hiddenGMNotes": "Track mentally or note when reroll used. Payoff can be sessions later."
        },
        "boots_of_safe_passage": {
            "id": "boots_of_safe_passage",
            "name": "Boots of Safe Passage",
            "type": "armor",
            "statModifiers": { "speed": 2 },
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "Soft boots that seem to know the path. +2 Speed.",
            "icon": "👢",
            "price": { "gold": 5 },
            "rarity": "uncommon",
            "tags": ["cursed", "boots"],
            "isCursed": true,
            "curseStyle": "narrative",
            "hiddenGMDescription": "The boots choose safety over intention.",
            "hiddenGMAbility": "The boots always choose the safest route rather than the route the player intended (GM call in travel scenes).",
            "hiddenGMNotes": "No combat penalty — wrong turns and missed shortcuts are the curse."
        },
        "sword_of_echoes": {
            "id": "sword_of_echoes",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "A blade that murmurs after every kill. +4 Strength. Damage: 1d10.",
            "icon": "⚔️",
            "price": { "gold": 11 },
            "rarity": "epic",
            "tags": ["cursed", "sword"],
            "isCursed": true,
            "curseStyle": "trigger",
            "hiddenGMDescription": "The dead do not stay quiet around this steel.",
            "hiddenGMAbility": "Every creature slain whispers to the wielder in their dreams — gradually revealing secrets, truths, and lies.",
            "hiddenGMNotes": "Optional Whispers counter for long campaigns. Reveals are story rewards with a cost.",
            "counterLabel": "Whispers",
            "counterDefault": 0,
            "counterMax": 99
        },
        "ring_of_friendship": {
            "id": "ring_of_friendship",
            "name": "Ring of Friendship",
            "type": "accessory",
            "statModifiers": { "magicalDefence": 2 },
            "specialEffects": [],
            "desc": "A warm wooden ring that smells of hay and honey. +2 Magical Defence. Animals naturally trust the wearer.",
            "icon": "💍",
            "price": { "gold": 4 },
            "rarity": "common",
            "tags": ["cursed", "ring"],
            "isCursed": true,
            "curseStyle": "narrative",
            "hiddenGMDescription": "Kindness draws attention — not all of it gentle.",
            "hiddenGMAbility": "Hostile monsters become curious rather than immediately aggressive. This is not always beneficial.",
            "hiddenGMNotes": "Curious ogres still exist. Roleplay tool, not a charm spell."
        }
    },
    "unidentified_loot": {
        "unknown_sword": {
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This sword is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real sword you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_axe": {
            "id": "unknown_axe",
            "name": "??? Axe",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This axe is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real axe you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_dagger": {
            "id": "unknown_dagger",
            "name": "??? Dagger",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This dagger is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real dagger you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_staff": {
            "id": "unknown_staff",
            "name": "??? Staff",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This staff is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real staff you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_bow": {
            "id": "unknown_bow",
            "name": "??? Bow",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This bow is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real bow you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_hammer": {
            "id": "unknown_hammer",
            "name": "??? Hammer",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This hammer is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real hammer you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_polearm": {
            "id": "unknown_polearm",
            "name": "??? Polearm",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This polearm is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real polearm you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_ring": {
            "id": "unknown_ring",
            "name": "??? Ring",
            ...
            "statModifiers": {},
            "specialEffects": [],
            "desc": "This ring is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real ring you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_amulet": {
            "id": "unknown_amulet",
            "name": "??? Amulet",
            ...
            "statModifiers": {},
            "specialEffects": [],
            "desc": "This amulet is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real amulet you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_cloak": {
            "id": "unknown_cloak",
            "name": "??? Cloak",
            ...
            "statModifiers": {},
            "specialEffects": [],
            "desc": "This cloak is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real cloak you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_armour": {
            "id": "unknown_armour",
            "name": "??? Armour",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This armour is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real armour you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_shield": {
            "id": "unknown_shield",
            "name": "??? Shield",
            ...
            "specialEffects": [],
            "enchantmentSlots": 0,
            "desc": "This shield is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            "unidentifiedItem": true,
            "sellable": false,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real shield you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_vial": {
            "id": "unknown_vial",
            "name": "??? Vial",
            ...
            "statModifiers": {},
            "specialEffects": [],
            "desc": "This vial is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            ...
            "sellable": false,
            "stackable": true,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real potion or elixir you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_scroll": {
            "id": "unknown_scroll",
            "name": "??? Scroll",
            ...
            "statModifiers": {},
            "specialEffects": [],
            "desc": "This scroll is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            ...
            "sellable": false,
            "stackable": true,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real scroll you prepared. Until then, you may tell the player what it does if you have already decided."
        },
        "unknown_item": {
            "id": "unknown_item",
            "name": "??? Item",
            ...
            "statModifiers": {},
            "specialEffects": [],
            "desc": "This item is unknown to you. The GM may have the knowledge for this item prepared in advance for you to be able to use it without prior knowledge. You must visit a town to get it identified to understand what it does.",
            "icon": "❓",
            "price": { "copper": 0 },
            "rarity": "common",
            "tags": ["unidentified", "loot"],
            ...
            "sellable": false,
            "stackable": true,
            "hiddenGMNotes": "When the party identifies this at a town, remove it and grant the real item you prepared. Until then, you may tell the player what it does if you have already decided."
        }
    }
};
